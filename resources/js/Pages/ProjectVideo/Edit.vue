                ...
                <div class="grid grid-cols-12 relative">
                    ...
                    <div class="col-span-6 p-2">
                        ...
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-3 mb-3 p">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="text-base text-black/80">Vd: https://www.youtube.com/watch?v=-OlpNX66a2M</div>
                                <div class="text-base text-black/80 mb-2">Mã sẽ là <span class="bg-black text-white px-5 ">-OlpNX66a2M</span></div>
                    ...
                    <div class="col-span-12 p-2">
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-2 mb-3">
                            <label for="data_content" class="block mb-2 font-bold text-base text-gray-900 dark:text-dark">Nhập Info</label>
...
export default {
    ...
    name: 'Edit Category ProjectVideo',
    components: {
            ...
            axios.post('', {
                ...
                .then((response) => {
                    if (response.data.error) {
                        ...
                        this.$inertia.visit(route('ProjectVideo'));
                    }
                })
                .catch((error) => {
                    console.log(error);
