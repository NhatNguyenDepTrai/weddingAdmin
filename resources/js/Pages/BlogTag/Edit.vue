...
<template>
    <AppLayout title="Sửa Tag Bài Viết">
        ...
        <div class="overflow-hidden  px-5 mb-3 ">
            <div class="w-100  p-1 flex justify-between items-center">
                <div class="">
                    <Link :href="route('BlogTag')" class="text-dark-700 hover:text-purple-900 font-bold underline decoration-1">
            ...
            axios.post('', {
                ...
                .then((response) => {
                    if (response.data.error) {
                        ...
                        this.$inertia.visit(route('BlogTag'));
                    }
                })
                .catch((error) => {
                    console.log(error);
