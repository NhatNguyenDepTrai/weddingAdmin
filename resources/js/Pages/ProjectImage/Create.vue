    ...
    <AppLayout title="Thêm  bộ ảnh">
        ...
        <div class="overflow-hidden  px-5 mb-3 ">
            <div class="w-100  p-1 flex justify-between items-center">
                <div class="  ">
                    <Link :href="route('ProjectImage')" class="text-dark-700 hover:text-purple-900 font-bold underline decoration-1">
                ...
                <div class="grid grid-cols-12 relative">
                        ...
                        <div class="grid grid-cols-12">
                            ...
                            <div class="col-span-6 p-2">
                                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg w-full p-3 mb-3 p">
                                    <div class="mb-3">
                                        <label for="name" class="block mb-2 font-bold text-base text-gray-900 dark:text-dark">Bộ Ảnh</label>
                    ...
                    <div class="col-span-12 p-2">
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-2 mb-3">
                            <label for="editer" class="block mb-2 font-bold text-base text-gray-900 dark:text-dark">Info</label>
                            <Editer ref="content" />
                        </div>
                    </div>
                    <div class="col-span-6 p-2">
