            ...
            <div class="max-w-12xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg pt-8 pb-12 px-2">
                    ...
                    <div class="float-right text-xs uppercase">
                        <Link :href="route('ProjectImage.trash')" class="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-2 rounded mr-4">
                        <icon :icon="['fas', 'trash']" class="mr-3" />Thùng rác ({{ trashCount }})
                        </Link>
                        <Link :href="route('ProjectImage.create')" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-2 rounded ">
                        ...
                        <DataTable :headers="headers" :items="dataPage" buttons-pagination show-index v-model:items-selected="itemsSelected">
                            ...
                            <template #item-operation="{ id, name }">
                                <div class="py-3 flex items-center justify-center">
                                    ...
                                    <Link :href="route('ProjectImage.edit', id)" class="bg-yellow-600 text-white px-2 py-1 rounded-md mr-5">
                            ...
                            <template #expand="item">
                                <div class="py-4  px-3 bg-neutral-950 text-white">
                                    ...
                                    <div class="grid grid-cols-12 mb-3 w-full">
                                        ...
                                        <div class="col-span-9 p-2 border">
                                            <div class="flex overflow-x-scroll" v-if="item.list_images.length > 0">
                                                <div v-for="image in item.list_images ">
                                                    <div class="mx-1 w-20 h-auto">

                                                        <img :src="image.url_image" alt="vinawebapp.com" class="w-20 h-auto  ">
                                                    </div>
                                                </div>
                                            </div>
                                            <div v-else>
...
export default {
    ...
    setup() {
        ...
        const loadData = () => {
            axios.post('project-image/load-data-table')
                .then((response) => {
